...
def add_fit_args(parser):
    ...
    args.add_argument('--max-epoches', type=int, default=120,
    ...
    args.add_argument('--print-freq', '-p', type=int, default=20,
                      help='print frequency (default: 10)')
    args.add_argument('-b', '--batch-size', type=int, default=256,
                      help='mini-batch size (default: 256)')
    args.add_argument('--num-classes', type=int, default=26,
    ...
    args.add_argument('--seg', type=int, default=10,
